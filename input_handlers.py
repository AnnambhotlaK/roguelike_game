# Takes actions and makes responses
...
class PopupMessage(BaseEventHandler):
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        """
        Render the parent and dim the result, then print the message.
        """
...
class AskUserEventHandler(EventHandler):
    ...
    def on_exit(self) -> Optional[ActionOrHandler]:
        ...
        By default, returns them to the main event handler.
        """
...
class SelectIndexHandler(AskUserEventHandler):
    ...
    def __init__(self, engine: Engine):
        """
        Sets the cursor to the player when
        this handler is constructed.
        """
...
class AreaRangedAttackHandler(SelectIndexHandler):
    ...
    Any entities within the area will be affected.
    """
...
class MainGameEventHandler(EventHandler):
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        ...
        if key == tcod.event.KeySym.N3 and modifier & (
...
class HistoryViewer(EventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[MainGameEventHandler]:
        ...
        else:  # Any other key moves back to the main games state.
            return MainGameEventHandler(self.engine)
        return None